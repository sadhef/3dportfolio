...
const Contact = () => {
  ...
  const earthVariants = prefersReducedMotion
    ? {
        hidden: { opacity: 0 },
      ...
      >
        ...
        {formSubmitted ? (
          <motion.div 
            ...
            className="mt-12 bg-tertiary py-8 px-6 rounded-lg text-center"
          >
            ...
            <button
              ...
              className="bg-white py-3 px-8 rounded-xl outline-none w-fit text-black font-bold shadow-md shadow-primary mx-auto"
            >
          ...
          >
            ...
            <button
              ...
              } py-3 px-8 rounded-xl outline-none w-fit text-black font-bold shadow-md shadow-primary transition-colors duration-200`}
        ...
        {canRenderEarth ? (
          ...
          <div className="w-full h-full flex items-center justify-center bg-tertiary rounded-2xl">
            <div className="text-center p-8">
              <h4 className="text-white text-xl mb-4">Connect With Me</h4>
